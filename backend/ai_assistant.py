...
SYSTEM_PROMPT = (
    ...
    "- ALWAYS reply in the SAME language and script the user wrote their latest "
    "message in. If they write in Marathi, reply in Marathi; Hindi -> Hindi; "
    "Gujarati -> Gujarati; English -> English, and so on. Only switch languages "
